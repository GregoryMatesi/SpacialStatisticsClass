...
The estimated intensity function seems to vary over space. This suggest we have more pines growing at the modes of the intensity function and less pines growing between the nodes. This could indicate that we may was a departure from Complete Spatial Randomness. Further analysis would be needed to confirm this.
...
```
Based on this plot, there is no evidence of departure from Complete Spatial Randomness across any spatial scale from 0 to 0.25. The lines fall within our envelope across the entire spatial scale tested.
